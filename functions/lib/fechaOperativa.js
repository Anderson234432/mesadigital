...
// (== "00:00", el comportamiento de antes) en vez de lanzar un error — un
// dato de configuración corrupto no debe tumbar crearPedido.
...
function fechaOperativa(timestampMs, horaCierreOperativo) {
...
// día calendario.
function inicioDiaOperativo(fechaStr, horaCierreOperativo) {
...
function rangoDiaOperativo(fechaStr, horaCierreOperativo) {
...
function fechaOperativaHoy(horaCierreOperativo) {
